...
router.get('/:recipientId', auth_1.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var messages, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, message_1.Message.find({
                        $or: [
...
router.post('/send', auth_1.authenticateToken, fileUpload_1.upload.single('media'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, recipientId, content, media, message, error_2;
